...
- Рисование / рисует разными цветами / добавляет нарисованное на картинку
- Линия / отрисовывает линию разными цветами / добавляет эту линию на картинку
- Прямоугольник / отрисовывает прямоугольник разными цветами / добавляет этот прямоугольник на картинку
...
//Доделать тулсы (выбор цветов, толщины, шрифтов, перенос строки и.т.д)
